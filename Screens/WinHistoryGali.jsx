...
const WinHistoryGali = ({ navigation }) => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const response1 = await axios.get('http://192.168.1.7:3000/api/auth/profile', {
                headers: {
            ...
            const response = await axios.get('http://192.168.1.7:3000/api/galidesawar/all-winners', {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
